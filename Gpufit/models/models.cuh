...
#include "spim_acf.cuh"
#include "spim_acfN.cuh"
#include "spim_acfN_2d.cuh"
    ...
    int const user_info_size)
{
    ...
    case SPLINE_3D_PHASE_MULTICHANNEL:
        ...
        break;
    case SPIM_ACF:
        calculate_spim_acf(parameters, n_fits, n_points, value, derivative, point_index, fit_index, chunk_index, user_info, user_info_size);
        break;
    case SPIM_ACFN:
        calculate_spim_acfN(parameters, n_fits, n_points, value, derivative, point_index, fit_index, chunk_index, user_info, user_info_size);
        break;
    case SPIM_ACFN_2D:
        calculate_spim_acfN_2d(parameters, n_fits, n_points, value, derivative, point_index, fit_index, chunk_index, user_info, user_info_size);
        break;
    default:
...
void configure_model(ModelID const model_id, int & n_parameters, int & n_dimensions)
{
    ...
    case SPIM_ACF:               n_parameters = 3; n_dimensions = 1; break;
    case SPIM_ACFN:              n_parameters = 5; n_dimensions = 1; break;
    case SPIM_ACFN_2D:           n_parameters = 4; n_dimensions = 1; break;
